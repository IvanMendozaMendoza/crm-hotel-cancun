...
export const ariaBuilder = {
  ...
  input: (
    ...
    return {
      ...
      ...(description && { "aria-describedby": description }),
      ...(error && {
        "aria-describedby": `${description || ""} ${error}`.trim(),
      }),
      ...(characterCount && {
        "aria-describedby": `${description || ""} ${characterCount}`.trim(),
      }),
      ...(hasAutocomplete && {
...
export const semanticHTML = {
  ...
  landmark: (
    ...
    role,
    "aria-label":
      ARIA_LABELS[role.toUpperCase() as keyof typeof ARIA_LABELS] || role,
  }),
  ...
  list: (
    ...
    role: type,
    "aria-label":
      ARIA_LABELS[type.toUpperCase() as keyof typeof ARIA_LABELS] || type,
  }),
};
...
export const validation = {
  ...
  createAriaAttributes: (
    ...
    ...(errorMessage && {
      "aria-describedby": generateAriaId("error", "message"),
    }),
  }),
